...
Color lBackgroundColor = const Color(0xFFFFFFFF); // Light green background
Color lFontColor = const Color(0xFF000000); // Dark green text color for light mode
...
Color lIndicatorColor = const Color(0xFF000000);

// Dark Mode Colors (Greenish)
Color dBackgroundColor = const Color(0xFF000000); // Dark green background
...
Color dButtonTextColor = const Color(0xFF000000); //r Dark text for buttons in dark mode
Color dCardColor = const Color(0xFF053410); // Darker green card background
...
Color dIndicatorColor = const Color(0xFFFFFFFF);
...
Color getIndicatorColor(bool isDarkMode) => isDarkMode ? dIndicatorColor : lIndicatorColor;